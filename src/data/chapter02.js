...
const chapter02 = {
  ...
  /* 자주 보는 처리 결과 번호 참고표 — 번호마다 한 행으로 보여 준다 */
  ...
  concept: {
    ...
    roles: [
      ...
      },
      {
        ...
        tech: "Status Code",
        desc:
          "서버가 처리 결과를 숫자로 알려 줍니다. 본문을 읽기 전에 이 숫자만 봐도 " +
          "요청이 어떻게 됐는지 알 수 있습니다. 번호별 의미는 아래 참고표에 정리해 두었습니다."
      },
      {
  ...
  summary: {
    remember: [
      ...
      "응답서의 처리 결과 번호 하나만 봐도 요청이 어떻게 됐는지 먼저 알 수 있다.",
      "번호마다 뜻이 정해져 있고, 어떤 번호가 있는지는 위 참고표에서 찾아보면 된다."
    ],
    points: [
      "Browser와 Server는 정해진 서식의 요청서와 응답서를 주고받는다.",
      "요청서는 Method(무엇을 할지) · URL(무엇을 대상으로) · Headers · Body로 이루어진다.",
      "응답서의 Status Code 숫자 하나로 결과를 먼저 판단할 수 있다. 번호별 의미는 참고표에서 확인한다.",
