...
const chapter12 = {
  ...
  intro:
    ...
    "주소를 계속 늘리는 대신, 주소는 '무엇을'만 가리키게 두고 '어떻게 하겠다'는 Method로 나눕니다. " +
    "그러면 주소만 봐도 무엇을 다루는지 알 수 있습니다.",
  ...
  concept: {
    ...
    roles: [
      ...
      },
      {
        ...
        tech: "Status Code",
        desc:
          "200은 처리했고 결과를 함께 보냈다, 201은 새로 만들었다, " +
          "204는 처리했지만 돌려줄 내용이 없다, 405는 그 주소가 그 Method를 받지 않는다는 뜻입니다."
      }
    ],
    note:
